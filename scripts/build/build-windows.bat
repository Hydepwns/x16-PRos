...
powershell -Command "$stream = [System.IO.File]::OpenWrite('img\x16pros.img'); $bytes = [System.IO.File]::ReadAllBytes('bin\kernel.bin'); $stream.Position = 512 * 9; $stream.Write($bytes, 0, $bytes.Length); $stream.Close()"
...
powershell -Command "$stream = [System.IO.File]::OpenWrite('disk_img\x16pros.img'); $bytes = [System.IO.File]::ReadAllBytes('bin\fs.bin'); $stream.Position = 512 * 1; $stream.Write($bytes, 0, $bytes.Length); $stream.Close()"
REM Assuming fs.bin fits within 4 sectors (1 boot + 4 fs = 5). Kernel starts at sector 5.
powershell -Command "$stream = [System.IO.File]::OpenWrite('img\x16pros.img'); $bytes = [System.IO.File]::ReadAllBytes('bin\write.bin'); $stream.Position = 512 * 10; $stream.Write($bytes, 0, $bytes.Length); $stream.Close()"
powershell -Command "$stream = [System.IO.File]::OpenWrite('img\x16pros.img'); $bytes = [System.IO.File]::ReadAllBytes('bin\brainf.bin'); $stream.Position = 512 * 13; $stream.Write($bytes, 0, $bytes.Length); $stream.Close()"
powershell -Command "$stream = [System.IO.File]::OpenWrite('img\x16pros.img'); $bytes = [System.IO.File]::ReadAllBytes('bin\barchart.bin'); $stream.Position = 512 * 16; $stream.Write($bytes, 0, $bytes.Length); $stream.Close()"
powershell -Command "$stream = [System.IO.File]::OpenWrite('img\x16pros.img'); $bytes = [System.IO.File]::ReadAllBytes('bin\snake.bin'); $stream.Position = 512 * 18; $stream.Write($bytes, 0, $bytes.Length); $stream.Close()"
powershell -Command "$stream = [System.IO.File]::OpenWrite('img\x16pros.img'); $bytes = [System.IO.File]::ReadAllBytes('bin\calc.bin'); $stream.Position = 512 * 20; $stream.Write($bytes, 0, $bytes.Length); $stream.Close()"
